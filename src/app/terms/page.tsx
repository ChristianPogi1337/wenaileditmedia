...
const termsContent = [
  {
    ...
    content: "By accessing and using We Nailed It Media's services, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services."
  },
  {
    title: "2. Service Description",
    content: "We Nailed It Media provides digital marketing, content creation, and related services. We reserve the right to modify, suspend, or discontinue any aspect of our services at any time."
  },
  {
    title: "3. Client Obligations",
    content: "Clients agree to provide necessary materials, feedback, and access required for service delivery in a timely manner. Delays from the client may impact project timelines."
  },
  {
    title: "4. Intellectual Property",
    content: "All materials, designs, and content created by We Nailed It Media remain our intellectual property until full payment is received, after which specified rights transfer to the client."
  },
  {
    title: "5. Payment Terms",
    content: "Payment schedules and terms will be outlined in individual service agreements. Late payments may result in service suspension and additional fees."
  }
];
    ...
    <div className={`${dmSans.className} min-h-screen bg-white`}>
      <nav className="fixed w-full bg-white shadow-lg z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4 lg:px-8">
          <div className="relative w-[180px] h-[80px] fixed left-4 top-0 z-50">
          ...
          <div className="max-w-3xl mx-auto px-4">
            <div className="prose prose-lg">
              <p className="text-gray-600 mb-12">
                These Terms of Service govern your use of We Nailed It Media's services. Please read them carefully.
              </p>
              ...
              >
                ...
                <p className="text-gray-600">
                  ...
                  <a href="mailto:legal@wenaileditmedia.com" className="text-black hover:underline">
                    legal@wenaileditmedia.com
                  </a>
                </p>
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
              <div className="space-y-6">
                ...
                <p className="font-['Gilroy'] text-white/80 text-sm">
                  Creating impactful digital experiences through innovative solutions since November 2020
                </p>
              </div>
